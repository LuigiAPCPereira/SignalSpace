...
| Decisões duráveis | [`docs/PRODUCT.md`](docs/PRODUCT.md), [`docs/ADR_LOCAL_AUTHORIZATION_V2.md`](docs/ADR_LOCAL_AUTHORIZATION_V2.md), [`docs/LOCAL_ADMIN_AUTHORIZATION.md`](docs/LOCAL_ADMIN_AUTHORIZATION.md), [`docs/SESSION_LOG.md`](docs/SESSION_LOG.md) | ADRs são decisões reais; a ADR v2 é aceita, mas não implementada. |
