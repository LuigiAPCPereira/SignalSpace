...
func TestWriteScopeIsAbsentFromDefaultAndRejectsUnsafeConfiguration(t *testing.T) {
	...
	for _, bad := range []Config{
		...
		{ResourceURL: resourceURL, Issuer: "https://signalspace.example", Scope: scope, GitIndexScope: gitIndexScope, StateDir: t.TempDir(), OnRequest: func(RequestInfo) {}},
		{ResourceURL: resourceURL, Issuer: "https://signalspace.example", Scope: scope, CanIssueGitIndex: func(string) bool { return true }, StateDir: t.TempDir(), OnRequest: func(RequestInfo) {}},
		{ResourceURL: resourceURL, Issuer: "https://signalspace.example", Scope: scope, GitIndexScope: "untrusted:scope", CanIssueGitIndex: func(string) bool { return true }, StateDir: t.TempDir(), OnRequest: func(RequestInfo) {}},
		{ResourceURL: resourceURL, Issuer: "https://signalspace.example", Scope: scope, GitCommitScope: gitCommitScope, StateDir: t.TempDir(), OnRequest: func(RequestInfo) {}},
		{ResourceURL: resourceURL, Issuer: "https://signalspace.example", Scope: scope, CanIssueGitCommit: func(string) bool { return true }, StateDir: t.TempDir(), OnRequest: func(RequestInfo) {}},
		{ResourceURL: resourceURL, Issuer: "https://signalspace.example", Scope: scope, GitCommitScope: "untrusted:scope", CanIssueGitCommit: func(string) bool { return true }, StateDir: t.TempDir(), OnRequest: func(RequestInfo) {}},
